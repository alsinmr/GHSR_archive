...
for q in range(2):
    ...
    resids=[128,215,220,221,222,226,272,276,279,280,284,286,290,309,312]
    ...
    with open(os.path.join('contact_score','R_all.data' if q==1 else 'R.data'),'wb') as f:
        np.save(f,R,allow_pickle=False)
    with open(os.path.join('contact_score','r0_all.data' if q==1 else 'r0.data'),'wb') as f:
